...
const double accel_max = 0.3; //0.5; //1m/sec^2
const double alpha_max = 0.3; //0.2; // rad/sec^2
const double speed_max = 0.3; //0.5; //1 m/sec
const double omega_max = 0.3; //0.5; //1 rad/sec
